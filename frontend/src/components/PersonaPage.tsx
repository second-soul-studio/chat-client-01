...
export default function PersonaPage() {
    ...
    const activeTab = (['persona', 'history', 'memories'] as const).includes(
        searchParams.get('tab') as 'persona' | 'history' | 'memories'
    ) ? searchParams.get('tab') as 'persona' | 'history' | 'memories' : 'persona';
